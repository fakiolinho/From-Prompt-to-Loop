...
**On your machine first.** From this repo, pointed at yours:
    ...
    ./install.sh ~/code/my-app 28      put the loop in your repo
    cd ~/code/my-app
    ./run-loop.sh 28 --check           is there work?
    ./run-loop.sh 28                   hand it to the agent and watch
...
**Then on a clock.** From the Actions tab, run **qa-loop** with the `loop` folder and the `agent`
